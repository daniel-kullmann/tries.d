...
alias TrieAA = DataTrie_AA!string;
...
void testWordFile(TrieAA trie, string filename, uint multiples) {
    if (exists(filename)) {
...
{
    auto trie = new Trie();
    auto trie_aa = new TrieAA();

    writeln("# Regular trie");
    ...
    writeln("# AA trie");
    testWordFile(trie_aa, "/usr/share/dict/cracklib-small", 10);
    testWordFile(trie_aa, "/usr/share/dict/american-english", 5);
    testWordFile(trie_aa, "/usr/share/dict/american-english-insane", 2);
